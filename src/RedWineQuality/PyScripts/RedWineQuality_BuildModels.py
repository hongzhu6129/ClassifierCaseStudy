...
s=time.time()
meta = LogisticRegression(max_iter=10000, fit_intercept=False, C=10000)
stack3 = StackingClassifier(estimators = [('knn2',knn2),('tree',dtree),('soft2',soft_vote2),('hard2',hard_vote2)],final_estimator=meta) #('hard',hard_vote),
stack3 = classification_model2(stack3, X_train, predict, y_train) #('hard',hard_vote),
